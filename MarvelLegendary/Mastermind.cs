...
namespace MarvelLegendary
{
    public class Mastermind
    {
        ...
        private readonly List<MastermindInfo> _masterminds = new List<MastermindInfo>()
        {
            ...
            new MastermindInfoBuilder().SetMastermindName("Epic Arcade").SetMastermindSet(GameInfo.Set.XMen).LeadsVillain("Murderworld").Build(),
            ...
            new MastermindInfoBuilder().SetMastermindName("Epic Dark Phoenix").SetMastermindSet(GameInfo.Set.XMen).LeadsVillain("Hellfire Club").Build(),
            ...
            new MastermindInfoBuilder().SetMastermindName("Epic Mojo").SetMastermindSet(GameInfo.Set.XMen).LeadsVillain("Mojoverse").Build(),
            ...
            new MastermindInfoBuilder().SetMastermindName("Epic Onslaught").SetMastermindSet(GameInfo.Set.XMen).LeadsVillain("Dark Descendants").Build(),
            new MastermindInfoBuilder().SetMastermindName("Shadow King").SetMastermindSet(GameInfo.Set.XMen).LeadsVillain("Shadow-X").Build(),
            new MastermindInfoBuilder().SetMastermindName("Epic Shadow King").SetMastermindSet(GameInfo.Set.XMen).LeadsVillain("Shadow-X").Build(),
