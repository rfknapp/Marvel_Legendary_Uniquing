...
namespace MarvelLegendary
{
    ...
    public static class VillainRepository
    {
        private static readonly List<VillainInfo> _villains = new List<VillainInfo>()
        {
            ...
            //new VillainInfo(103, "Lords of the Nether Realm", Set.Strange),
            //
    ...
    public class Villain
    {
        ...
        private static List<Villain> ConvertToVillainList(List<VillainInfo> villainInfoList)
        {
            var returnList = new List<Villain>();
            foreach (var villainInfo in villainInfoList)
            {
                returnList.Add(
                    new Villain
                    {
        ...
        public List<string> GetListOfVillainsByX(string cardType, string name)
        {
            ...
            var allVillainsByX = new DatabaseHelper().GetList(allVillainsBy);
